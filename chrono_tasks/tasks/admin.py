...
class EpicAdmin(admin.ModelAdmin):
    list_display = ('id', 'display_id', 'name', 'content', 'started_at', 'ended_at', 'created_by_user_id', 'created_at', 'updated_at')
    search_fields = ('id', 'display_id', 'name', 'content', 'started_at', 'ended_at', 'created_by_user_id', 'created_at')
    ordering = ('-created_at',)
    list_editable = ('display_id', 'name', 'started_at', 'ended_at')
